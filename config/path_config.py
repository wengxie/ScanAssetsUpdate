...
# EXCEL_PATH = r'E:\trunkCHS\datapool\ElementData\BaseData'
# ASSETS_DIRECTORY = r'E:\trunkCHS\client\MainProject\Assets'
...
# 国内Unity工程路径下的项目路径
DOMESTIC_UNITY_ROOT_PATH = r'D:\svn\svnReleasebranchesCHS'

# 海外Unity工程路径下的项目路径
GLOBAL_UNITY_ROOT_PATH = r'D:\svn\Dev_global'

# 用于扫描策划表是否导表的项目路径
ELEMENT_DATA_DPC_ROOT_PATH = r'D:\svn\svnReleasebranchesCHS'
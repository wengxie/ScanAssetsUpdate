...
# github链接“https://github.com/18311815797/DingtalkChatbot/blob/master/dingtalkchatbot/chatbot.py”
...
class DingtalkChatbot(object):
    ...
    #             logging.debug(
    #                 '钉钉官方限制机器人每分钟最多发送20条，当前发送频率已达限制条件，休眠 {}s'.format(str(sleep_time)))
    ...
    #             Files = f.read()
    #             uploadFiles = {
    #                 'file':  Files # 'filename'可以是任意值，用于描述文件
    #             }
    #         self.headers = {'Content-Type': 'multipart/form-data'}
    #         response = requests.post(self.webhook, headers=self.headers, files=uploadFiles)
    #         print(response.json())
    #         f.close()
